#-------------------------------------------------
#
# Project created by QtCreator 2015-05-03T20:10:19
#
#-------------------------------------------------
...
#CONFIG += qt opengl warn_on thread rtti console embed_manifest_exe no_keywords c++11
...
macx|darwin-g++ {
    ...
    OPENMESH_DIR = /Users/XiangSun/OpenMesh-3.3

    INCLUDEPATH += $${OPENMESH_DIR}/src
    DEPENDPATH += $${OPENMESH_DIR}/src
    INCLUDEPATH += $${EIGEN_DIR}
}

win32 {
EIGEN_DIR = C:/Users/sunx/Documents/lib/Eigen
OPENMESH_DIR = C:/Users/sunx/Documents/lib/OpenMesh
    DEFINES += _USE_MATH_DEFINES
    INCLUDEPATH += C:/Users/sunx/Documents/lib
    #Eigen3
    INCLUDEPATH += $${EIGEN_DIR}

    #OpenMesh
    INCLUDEPATH += $${OPENMESH_DIR}/include
    LIBS += -L$${OPENMESH_DIR}/lib -lOpenMeshCore
}
